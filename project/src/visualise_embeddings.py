...
if __name__ == "__main__":
    ...
    backbone.load_state_dict(torch.load("/home/ubuntu/users/mateusz/Scene-Representation/project/utils/models/backbones/weights/multimodal_network_rn50_neighbour_0.5.pth"))
